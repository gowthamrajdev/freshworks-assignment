...
const onClickFilter = () => {
  ...
  phoneNumber ? getCustomerCardTemplate(phoneNumber) : getCustomerCardTemplate();
}

const onClickcloseOrder = (customerId) => {
        ...
        ordersCard = ` <div class="fw-py-16">
            ...
            ${Object.keys(orderDetails)
              .map(
                (
                  order
                ) => `<section class="details fw-bg-smoke-25 order-card-all">
            <div
            ...
            <table class="order-item">
              ...
              <tr class="fw-b-0">
                ...
                <a href="#">
                  <td class="fw-b-0 fw-type-h6 fw-color-azure-800">${
                    orderItem.quantity
                  }</td>
                </a>
              </tr>
...
function getCustomerCardTemplate(phoneNumber) {
  const customerDetailsurl = phoneNumber
    ? `${AWS_DOMAIN}/customer-details?phoneNumber=${phoneNumber}`
    : `${AWS_DOMAIN}/customer-details`;
